...
class InteRNetBlock(nn.Module):
    ...
    def __init__(
        ...
        self.convp1 = Conv[Conv.CONV, spatial_dims](
...
class InteRNet(nn.Module):
    ...
    def __init__(
        ...
        conv_pre = Conv[Conv.CONV, spatial_dims](in_channels=filters, out_channels=filters,groups=filters, kernel_size=kernel_size, padding=1, bias=False)
