...
max_samples=4 #max number of samples to use for training
...
ensemble=1 # 0 for no 1 for yes to ensemble
avgmodel=0 # switch to average model 1=yes
plot=2 # only applicable in ensemble, 1= ensemble and plot, 2 evaluate all models
eval_path='/scratch/a.bip5/BraTS 2021/ssensemblemodels0922/Evaluation Folder C' # where to load the eval models for ensemble from
...
val=0 # whether or not to only use the training set
schedule_epochs = 0
lr=1e-4
weight_decay=1e-5
val_interval = 1
