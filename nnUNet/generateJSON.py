...
if __name__ == '__main__':
    ...
    generate_dataset_json(join(target_base, 'dataset.json'), target_imagesTr, target_imagesTs, ('FLAIR', 'T1', 'T1C','T2'),
                          labels={0: 'background', 1: 'edema',2:'tumour Core',3:'enhancing tumour'}, dataset_name=task_name, license='hands off!')
